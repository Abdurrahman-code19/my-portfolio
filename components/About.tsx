...
const highlights = [
  {
    icon: Target,
    label: "My Mission",
    text: "To build performant, accessible web interfaces that deliver delightful user experiences.",
  },
  {
    icon: Focus,
    label: "Professional Focus",
    text: "Frontend Development, UI Engineering, Interactive Web Experiences",
  },
  {
    icon: Shield,
    label: "Core Strengths",
    text: "Problem Solving, Clean Code, Responsive Design, Performance Optimization",
  },
  {
    icon: Zap,
    label: "Current Focus",
    text: "React, TypeScript, Next.js, Three.js, and Motion Design",
  },
];

export default function About() {
  return (
    <section id="about" className="section-padding bg-navy-secondary relative overflow-hidden">
              ...
              {highlights.map((h, i) => (
                ...
                >
                  <div className="flex items-start gap-3">
                    <div className="p-2.5 rounded-[12px] bg-accent/15 text-accent shrink-0">
                      <h.icon size={16} />
                    </div>
                    <div>
                      ...
                      <p className="text-sm text-text-body leading-relaxed">{h.text}</p>
                    </div>
                  </div>
                </motion.div>
              ))}
